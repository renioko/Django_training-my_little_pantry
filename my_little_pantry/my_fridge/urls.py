...
from .views import fridge_view, add_fridge_product, remove_fridge_product, check_expired_view, remove_expired_fridge_products, remove_fridge_product_list, remove_products_checkboxes_form, remove_defaults
